...
<head>
    <meta charset="UTF-8">
    <title>坤玛机电　工业机电产品一站式采购中心</title>
...
<div class="gn-gallery" id="gn-gallery">
    <ul id="gn-advertis">
        <li class="gn-advertis-img"><img class="ad-img0" src="" alt=""></li>
        <li class="gn-advertis-img"><img class="ad-img1" src="" alt=""></li>
        <li class="gn-advertis-img"><img class="ad-img2" src="" alt=""></li>
        <li class="gn-advertis-img"><img class="ad-img3" src="" alt=""></li>
        <li class="gn-advertis-img"><img class="ad-img4" src="" alt=""></li>
        <!--
...
<main class="gn-body">
            ...
            <div class="req-top">
                ...
                <div class="right-pane">
                    ...
                    <form enctype="multipart/form-data">
                        ...
                        <button class="upload-btn" id="uploadBtn">上传照片或附件</button>
    ...
    <section class="about-km template" id="about-km">
        <div class="wrapper">
            <h3>联系我们</h3>
            <div class="contact">
                <p>客服热线：021-51082175</p>
                <p>销售热线：15921215218/15901651735</p>
                <p>技术热线：13816377155/13671766941</p>
                <p>传&emsp;&emsp;真：021-56035011</p>
                <p>公司地址：上海市静安区灵石路大徐家阁199号</p>
                <p>邮&emsp;&emsp;箱：admin@comeon365.com</p>
            </div>
            <h3>关于我们</h3>
            <div>
                坤玛机电专注于万亿规模的工业机电市场，为各类中小企业提供工业机电（自动化&MRO）产品一站式采购平台。帮助中小企业降低采购成本、提升效率、促进行业所有从业人员参与共享增加收入。
            </div>
            <h3>服务行业</h3>
            <div>
        ...
        <div class="me-content">
            ...
            <div class="m-wrap account-wrap" id="account-wrap">
                ...
                <dl>
                    ...
                    <dd>名称：上海坤玛机电有限公司</dd>
                    <dd>开户行：渣打银行（中国）有限公司上海分行</dd>
                    <dd>账号：501510705921</dd>
                    <dd>渣打行号：671290000017</dd>
                    <br/>
                    <dd>名称：上海坤玛机电有限公司</dd>
                    <dd>开户行：交行市北工业区支行</dd>
