...
app.controller('tabsCtrl', ['$scope', '$ionicHistory', function ($scope, $ionicHistory) {
    ...
    function ($scope, $interval, $state, server, popup, config, appModel) {
        ...
        $scope.signIn = function () {
            ...
            server.register(req).then(function (data) {
                ...
                flag = true;
                popup.alert({btnText: '确认', msg: '注册失败!'});
            });
...
app.controller('productDetailCtrl', ['$scope', '$stateParams', '$state', '$filter', 'server', 'wechat', 'appModel', 'popup', 'config',
    function ($scope, $stateParams, $state, $filter, server, wechat, appModel, popup, config) {
        ...
        $scope.initPage = function () {
            server.getProductDetail(psid).then(function (data) {
                ...
                var shareData = {
                        ...
                        desc: '价格:￥' + $scope.productDetail.price + '  ' + $scope.productDetail.describemodel
                    };
